...
var buttonincrement = document.getElementsByClassName('plus'); console.log(buttonincrement);
var buttondecrement = document.getElementsByClassName('minus'); console.log(buttondecrement);
